...
const Main = () => {
  return (
    <main>
      <div className="main container m-auto flex flex-col gap-6">
        <div className="text my-20 grid place-items-center px-7 text-center gap-6 text-[--Very-Dark-Cyan] txt-shadow">
          ...
          <button className="text-white Open-Sans font-semibold bg-[--Pink] px-6 py-2 rounded-full box-shadow mt-8 md:py-4 md:px-12">
            Get Started For Free
          </button>
        </div>
        <div className="image grid place-content-center">
          <img src={mainImage} alt="main Image" className="w-[] " />
        </div>
      </div>
    </main>
  );
